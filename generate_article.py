...
INTRO = "金边泰式按摩以其传统手法和优质服务深受游客和本地居民喜爱。本文为您推荐金边几家口碑极佳的泰式按摩店，帮助您在繁忙的旅途中放松身心。"

WHY_CHOOSE = "为什么选择金边泰式按摩？"

WHY_POINTS = [
    "传统泰式手法结合本地特色，按摩力度恰到好处",
    "技师经过专业培训，服务质量有保障",
    "环境温馨舒适，私密性良好",
    "价格公道透明，性价比极高"
]
...
# 价格表格数据
MARKET_DATA = [
    ("基础泰式", "$20-40", "60分钟", "适合缓解疲劳"),
    ("精油SPA", "$50-80", "90分钟", "深层放松首选"),
    ("泰式草药的", "$60-100", "90分钟", "适合祛湿驱寒"),
    ("VIP套餐", "$120-200", "120分钟", "全套奢华体验")
]
